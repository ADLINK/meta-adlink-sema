...
/* Description 
 *   Invalid local time.
 *   Date is over 2038 year in Windows System.
 * Actions
 *   None.
 */
#define EAPI_STATUS_INVALID_LOCAL_TIME    EAPI_UINT32_C(0xFFFFFFFB)
...
#define EAPI_ID_HWMON_IO_CURRENT          EAPI_UINT32_C(0x22002)
...
#define EAPI_ID_GPIO_GPIO0A     EAPI_GPIO_GPIO_ID(10) /* (Optional) */
#define EAPI_ID_GPIO_GPIO0B     EAPI_GPIO_GPIO_ID(11) /* (Optional) */
#define EAPI_ID_GPIO_GPIO0C     EAPI_GPIO_GPIO_ID(12) /* (Optional) */
#define EAPI_ID_GPIO_GPIO0D     EAPI_GPIO_GPIO_ID(13) /* (Optional) */
#define EAPI_ID_GPIO_GPIO0E     EAPI_GPIO_GPIO_ID(14) /* (Optional) */
#define EAPI_ID_GPIO_GPIO0F     EAPI_GPIO_GPIO_ID(15) /* (Optional) */
...
/*  */
#define GPIOS_INTERCHANGED 1
#define GPIOS_NOT_INTERCHANGED 0

/**
*******************************************************************************
*	\FUNCTION	void gpioAssignment(int interchanged)
*
*	\DESCRIPTION
*		Early BMC equipped COM-Express-Boards have a interchanged
*		assignment of their GPIOs. If you have such a board, you may call
*		this function with the parameter GPIOS_INTERCHANGED. Otherwise,
*		you have to take care of this interchanged assignment yourself.
*		If you want to restore the normal assignment, use the parameter
*		GPIOS_NOT_INTERCHANGED.
*******************************************************************************
**/
void gpioAssignment(int interchanged);
